...
این مستند برای اتصال به سرویس API پلتفرم پیام آراد تهیه شده است. محتوا بر اساس مستندات قبلی Arad SMS Hub API و Monitoring API و همچنین نسخه فعلی سرویس API در branch `V4.0_Codex` به‌روز شده است.
